...
internal sealed class ViewModelFactory : IViewModelFactory
{
    ...
    private readonly TrackerProductSourceAutoGridBuilder _sourcesAutoGridBuilder;
        ...
        TrackerProductSourceAutoGridBuilder sourcesAutoGridBuilder)
    {
        ...
        _sourcesAutoGridBuilder = sourcesAutoGridBuilder.NotNull();
    }
    ...
    public ITrackerProductViewModel CreateTrackerProduct(Product? product)
    {
        return new TrackerProductViewModel(product, _eventBus, _commandBus, _agentQuery,
            _productQuery, _statusProvider, _uiDispatcher, _ui, _productInteraction,
            _sourcesAutoGridBuilder);
    }
}
